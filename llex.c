...
#include "ltable.h"
#include "lzio.h"
#ifndef LUA_KERNEL_LOCALE_HEADER
#define LUA_KERNEL_LOCALE_HEADER "locale/native/native_kernel_autogenerated.h"
#endif
#include LUA_KERNEL_LOCALE_HEADER
...
static const char *const luaX_default_tokens[] = LUA_KERNEL_BOOTSTRAP_TOKENS;
static const char *const kernel_keyword_keys[] = LUA_KERNEL_KEYWORD_KEYS;
static const char *const kernel_operator_keys[] = LUA_KERNEL_OPERATOR_KEYS;
static const char *const kernel_lexical_keys[] = LUA_KERNEL_LEXICAL_KEYS;
...
void luaX_setlocale (lua_State *L) {
  ...
  add_locale_op_noblock(L, LUA_KERNEL_DELIM_KEY_EXPRESSION_GROUPING_OPENING,
                        LUA_KERNEL_DELIM_DEFAULT_EXPRESSION_GROUPING_OPENING, '(');
  add_locale_op_noblock(L, LUA_KERNEL_DELIM_KEY_EXPRESSION_GROUPING_CLOSING,
                        LUA_KERNEL_DELIM_DEFAULT_EXPRESSION_GROUPING_CLOSING, ')');
  add_locale_op_noblock(L, LUA_KERNEL_DELIM_KEY_INDEX_OPENING,
                        LUA_KERNEL_DELIM_DEFAULT_INDEX_OPENING, '[');
  add_locale_op_noblock(L, LUA_KERNEL_DELIM_KEY_INDEX_CLOSING,
                        LUA_KERNEL_DELIM_DEFAULT_INDEX_CLOSING, ']');
  add_locale_op_noblock(L, LUA_KERNEL_DELIM_KEY_CONSTRUCTOR_OPENING,
                        LUA_KERNEL_DELIM_DEFAULT_CONSTRUCTOR_OPENING, '{');
  add_locale_op_noblock(L, LUA_KERNEL_DELIM_KEY_CONSTRUCTOR_CLOSING,
                        LUA_KERNEL_DELIM_DEFAULT_CONSTRUCTOR_CLOSING, '}');
  add_locale_op_noblock(L, LUA_KERNEL_DELIM_KEY_ELEMENT_SEPARATOR,
                        LUA_KERNEL_DELIM_DEFAULT_ELEMENT_SEPARATOR, ',');
  add_locale_op_noblock(L, LUA_KERNEL_DELIM_KEY_STATEMENT_SEPARATOR,
                        LUA_KERNEL_DELIM_DEFAULT_STATEMENT_SEPARATOR, ';');
  locale_string_delim = locale_get(L, "delimiters",
                                   LUA_KERNEL_DELIM_KEY_STRING_DELIMITER,
                                   LUA_KERNEL_DELIM_DEFAULT_STRING_DELIMITER);
  if (locale_string_delim[0] == '\0')
    locale_string_delim = LUA_KERNEL_DELIM_DEFAULT_STRING_DELIMITER;
  locale_string_delim_len = strlen(locale_string_delim);
  locale_string_delim_alt =
    locale_get(L, "delimiters", LUA_KERNEL_DELIM_KEY_STRING_DELIMITER_ALTERNATE,
               LUA_KERNEL_DELIM_DEFAULT_STRING_DELIMITER_ALTERNATE);
