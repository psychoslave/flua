...
LUA_KERNEL_LOCALE_FILE= locale/$(LUA_KERNEL_LOCALE).lua
LUA_KERNEL_LOCALE_HEADER= locale/kernel_locale_autogenerated.h
LUA_KERNEL_LOCALE_INCLUDE=
ifneq ($(LUA_KERNEL_LOCALE),native)
LUA_KERNEL_LOCALE_INCLUDE= -include $(LUA_KERNEL_LOCALE_HEADER)
endif
...
regen-native-kernel-header:
	@test -f "$(LUA_KERNEL_LOCALE_FILE)" || \
		{ echo "error: locale file not found: $(LUA_KERNEL_LOCALE_FILE)"; exit 1; }
...
LOCALE_BUILD_PREREQS= clean all
ifneq ($(LUA_KERNEL_LOCALE),native)
LOCALE_BUILD_PREREQS= regen-native-kernel-header clean all
endif
...
llex.o: llex.c lprefix.h lua.h luaconf.h lctype.h llimits.h ldebug.h \
 ...
 lstring.h ltable.h locale/native_locale_kernel_autogenerated.h
