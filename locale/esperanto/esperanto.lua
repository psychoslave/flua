locale = {
  ...
  operators = {
    ...
    -- komparu kun oble kaj a*gl*omeri, aglutini
  ...
  repl = {
    ...
    ["standard·input·source·identity"] = "=normenigo",
  },
  ...
  diagnostics = {
    ...
    ["traceback·line·format·no·line"] = "\n\t%s: en ",
    ["traceback·line·format·with·line"] = "\n\t%s:%d: en ",
    ["traceback·function·name·format"] = "funkcio '%s'",
    ["traceback·function·source·format"] = "funkcio <%s:%d>",
    ["traceback·unknown·function"] = "?",
    ...
    ["error·message·not·string"] = "(erarmesaĝo ne estas ĉeno)",
    ...
    ["reader·function·must·return·string"] = "leganta funkcio devas redoni ĉenon",
    ...
    ["varinfo·kind·name"] = " (en %s '%s')",
    ["varinfo·kind·local"] = "loka variablo",
    ["varinfo·kind·upvalue"] = "suprevalo",
    ["varinfo·kind·global"] = "ĉiea valoro",
    ["varinfo·kind·field"] = "kampo",
    ["varinfo·kind·method"] = "metodo",
    ["varinfo·kind·constant"] = "konstanto",
    ["varinfo·kind·for·iterator"] = "por-iteraciilo",
    ["varinfo·kind·metamethod"] = "metametodo",
    ["varinfo·kind·hook"] = "hoko",
    ["operation·call"] = "voki",
    ["operation·concatenate"] = "kunligi",
    ["operation·get·length·of"] = "akiri longon de",
    ["operation·index"] = "indeksi",
    ["operation·perform·arithmetic·on"] = "fari aritmetikon sur",
    ["operation·perform·bitwise·operation·on"] = "fari bitan operacion sur",
    ["attempt·to·op·a·value"] = "provo %s je %s-valoro%s",
  ...
  aliases = {
    ...
    ["os·tmpname·method·alias"] = "efemeranomo",
    ["os·execute·method·alias"] = "plenumu",
    ["os·remove·method·alias"] = "forigu",
    ["io·open·method·alias"] = "ovru",
    ["io·input·method·alias"] = "enigu",
    ["io·read·method·alias"] = "legu",
    ["io·close·method·alias"] = "fermu",
    ["string·find·method·alias"] = "trovu",
    ["string·gsub·method·alias"] = "anstataŭigu",
